package com.aleksandrova;

import com.aleksandrova.entities.Customer;
...
public class CustomerDetails extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if ((customerNr != null) && !(customerNr.equals(""))) {
            ...
            if (client != null) {
               out.println("Customer's info for № " + customerNr + ": " + client.getLibraryName() + ", "
                        + client.getReadersCount() + ", " + client.getStatus());
            } else {
